...
class RedAutoOverFlow: MegiddoOpMode(AllianceColor.RED) {
    ...
    @JvmField var intakePose = Pose(125.944, 9.789)
...
//        InstantCommand{intakeCommand.schedule()},
        Delay(0.1),
        InstantCommand{ shootingCommand.schedule() },
//        transferAll(
//            SequentialGroup(
//                runTransfer
//            )
//        ),
        ...
        FollowPath({createPath(follower.pose, finishPose, follower.pose.heading, toRadians(180.0))})
    )
    )
