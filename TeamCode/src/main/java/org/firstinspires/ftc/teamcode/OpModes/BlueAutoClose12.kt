...
@Autonomous
@Configurable
class BlueAutoClose12: MegiddoOpMode(AllianceColor.BLUE) {
    ...
    @JvmField var gatePose = Pose(115.239, 88.887-10).mirror()
    @JvmField var preIntakePose3 = Pose(94.239, 88.887-24-22).mirror()
    @JvmField var preIntakePose4 = Pose(127.239, 88.887-24).mirror()
    ...
    override fun onInit(){
        ...
        moveToPreIntake = follower.pathBuilder()
            ...
            .setLinearHeadingInterpolation(Math.toRadians(180-180.0), Math.toRadians(180-180.0))
            .build()
        ...
        moveToPreIntake4 = follower.pathBuilder()
            ...
            .setLinearHeadingInterpolation(Math.toRadians(180.0-180.0), Math.toRadians(180.0-215.0))
            .build()
        moveToEndIntake4 = follower.pathBuilder()
            .addPath(BezierLine(preIntakePose4, endIntakePose4))
            .setConstantHeadingInterpolation(Math.toRadians(180.0-180.0))
            .build()
        moveToShooting5 = follower.pathBuilder()
            .addPath(BezierLine(endIntakePose4, shootingPose))
            .setLinearHeadingInterpolation(Math.toRadians(180.0-180.0), Math.toRadians(180.0-180.0))
            .build()
