 ...
 */
public class MyPinpointLoc implements Localizer {
    ...
    /**
     * This creates a new MyPinpointLoc from a HardwareMap, with a starting Pose at (0,0)
     * facing 0 heading.
     *
     * @param map the HardwareMap
     */
    public MyPinpointLoc(HardwareMap map, PinpointConstants constants){ this(map, constants, new Pose());}

    /**
     * This creates a new MyPinpointLoc from a HardwareMap and a Pose, with the Pose
     ...
     */
    @SuppressLint("NewApi")
    public MyPinpointLoc(HardwareMap map, PinpointConstants constants, Pose setStartPose){
