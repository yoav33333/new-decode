...
//
//    @JvmField var startingPose = Pose(92.211, 8.254, toRadians(180.0)).mirror()
//    @JvmField var shootingPose = Pose(92.211, 15.254).mirror()
//    @JvmField var preIntakePose = Pose(105.169, 34.479).mirror()
//    @JvmField var endIntakePose = Pose(129.169, 34.479).mirror()
//    @JvmField var preIntakePose2 = Pose(105.169, 34.479+24).mirror()
//    @JvmField var endIntakePose2 = Pose(134.169, 34.479+29).mirror()
//    //    @JvmField var preIntakePose = Pose(98.169, 34.479).mirror()
//
//    @JvmField var intakePoseHP = Pose(130.944, 5.789).mirror()
