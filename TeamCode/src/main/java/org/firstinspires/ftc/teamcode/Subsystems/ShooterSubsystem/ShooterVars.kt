...
object ShooterVars {
    ...
    fun createShooterLut(): InterpLUT{
        return createLUT(mapOf(61.3 to 850.0, 71.0 to 1150.0, 94.0 to 1230.0, 117.2 to 1400.0, 135.0 to 1450.0, 162.8 to 1610.0))
    }
    fun createHoodLUT(): InterpLUT{
        return createLUT(mapOf(61.3 to 0.00, 71.0 to 0.15, 94.0 to 0.28, 117.2 to 0.35, 135.0 to 0.35, 162.8 to 0.4))
    }
