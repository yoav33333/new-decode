...
object ShooterVars {
    ...
    @JvmField var kv = 0.00049
    @JvmField var angleCorrectMul = -0.001
    ...
    @JvmField var deltaThreshold = 60.0
    @JvmField var veloCoefficients: PIDCoefficients = PIDCoefficients(0.03, 0.0, 0.00)
    ...
    fun createHoodLUT(): InterpLUT{
        return createLUT(mapOf(61.3 to 0.10, 71.0 to 0.0, 94.0 to 0.15, 117.2 to 0.36, 135.0 to 0.49, 162.8 to 0.49))
    }
